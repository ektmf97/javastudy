...
public class MainClass {
  ...
  str2  | 0x456 |          
	...
	public static void substring() {
		...
		String givenName = name.substring(1); // 끝까지 이름 
	...
	public static void indexof() {
		...
		// indexof 사용법
		// 1. indexof(찾을 문자열 String str) : 인덱스 0부터 str을 검색
	...
	public static void replace() {
		...
		// replaceAll을 사용하면 변환을 61_78_121_242 기대하지만 다른 정답이 나옴(정규식에서 마침표는 모든 문자를 의미함)
	...
	public static void isEmpty() {
		...
		String str = " "; // " "; <- 빈 문자열이 아니다 / 빈 문자열로 표현하고 싶으면 앞에 trim() 붙혀준다
		if (str.trim().isEmpty()) {
	...
	public static void ex02() {
		...
		if(fullName.endsWith(".tar.gz")) {
			...
			fullName = fullName.substring(0,fullName.lastIndexOf(".")); // apple
			extName = fullName.substring(fullName.lastIndexOf(".")); // .jpg //확장자에 . 표가 포함되도록  
		}
