...
public class ClientMainClass { // ClientMainClass, client.sleep() - 서버로 텍스트 보내기 

	public static void main(String[] args) {
		
		Socket socket = null; // 예외처리 해야함
		
		// 클라이언트가 서버쪽으로 데이터 보냄 타이핑해서
		...
		try {
			...
			while(true) {
				System.out.println(" >>> ");
				String message = sc.nextLine(); // 엔터 누를 때 까지 입력받는 채팅 내용을 입력
