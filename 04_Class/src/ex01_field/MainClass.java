...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		user1.addr.jibnuAddress = "가산동";
				
		System.out.println("아이디 : " + user1.id);
		System.out.println("비밀버호 : " + user1.pw);
		System.out.println("포인트 : " + user1.point);
		System.out.println("VIP 여부 : " + user1.isVip);
		System.out.println("주소 : " + user1.addr.postcode + " " + user1.addr.roadAddress + "(" + user1.addr.jibnuAddress + ")");
		...
		System.out.println("주소 : " + user2.addr.postcode + " " +user2.addr.roadAddress + "(" + user2.addr.jibnuAddress + ")");
	}
}
