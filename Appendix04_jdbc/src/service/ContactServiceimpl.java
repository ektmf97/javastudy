...
public class ContactServiceimpl implements ContactService {
	...
	public void modifyContact() {
		...
		// contact 여기에는 5개 필드값을 모두 가지고 있다.
		System.out.println("수정할 항목 선택(1.이름 2.전화 3.이메일 4.주소) >>>"); // 연락처는 고유번호라서 못 바꿈
		String choice = sc.next();
		
		// 분기문 입력한 내용만 바뀌고 수정한 내용만 가지고 있다. 선택한 항목만 바꿔준다.
		switch(choice) {
		case "1" :
